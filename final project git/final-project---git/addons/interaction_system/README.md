...
> The version in GDScript is no longer supported, you can find the latest version
written in GDScript [here](https://codeberg.org/masshuu/godot-interaction-system/src/tag/v1.5.0).
...
You can find the documentation in the [docs](./docs/) folder and example in the
