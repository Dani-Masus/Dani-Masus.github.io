...
{
    [Signal]
    public delegate void InteractedWithInteractableEventHandler(Interactable interactable);
    [Signal]
    public delegate void LongInteractedWithInteractableEventHandler(Interactable interactable);
    [Signal]
    public delegate void ClosestToInteractableEventHandler(Interactable interactable);
    [Signal]
    public delegate void NotClosestToInteractableEventHandler(Interactable interactable);
    [Signal]
    public delegate void FocusedOnInteractableEventHandler(Interactable interactable);
    [Signal]
    public delegate void UnfocusedInteractableEventHandler(Interactable interactable);
