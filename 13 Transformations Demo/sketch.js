...
function draw() {
  ...
  //   push(); //this makes a copy of the coords system
  // translate(100, 50);
  // drawBasicGrid(150);
  // rectangleRed(0,0);
  // pop(); //discards the current coords system
  ...
  //reminder: rotations are measured in radians
  // , not degrees! Functions can help with the conversion...
...
function wagonWheel(){
  //create a wheel with a cross in the middle
  push();
  circle(150, 150, 200)
  strokeWeight(5);
  line(250, 150, 50, 150);
